...
import 'dart:collection' as $$i show HashSet;
...
class _PgdeLocalizationDelegate
    extends LocalizationsDelegate<PgdeLocalization> {
  const _PgdeLocalizationDelegate();
  ...
  @override
  Future<PgdeLocalization> load(Locale locale) =>
      SynchronousFuture<PgdeLocalization>(_getTranslation(locale));

  @override
  bool shouldReload(_PgdeLocalizationDelegate old) => false;

  static final Set<String> kSupportedLanguages =
      $$i.HashSet<String>.from(const <String>[
    'ar',
    'en',
    'zh',
  ]);

  static PgdeLocalization _getTranslation(Locale locale) {
    switch (locale.languageCode) {
      case 'ar':
        {
          return PgdeLocalizationAr();
        }
      ...
      case 'en':
        {
          switch (locale.countryCode) {
            case 'US':
              return PgdeLocalizationEnUs();
          }

          return PgdeLocalizationEn();
        }

      case 'zh':
        {
          return PgdeLocalizationZh();
        }
    }
...
class Dep {
  ...
  static Dep of(BuildContext context) => Localizations.of<Dep>(context, Dep);

  final String depValue = r'fromDep';
}
...
abstract class PgdeLocalization {
  ...
  static PgdeLocalization of(BuildContext context) {
    return Localizations.of<PgdeLocalization>(context, PgdeLocalization)
      .._$dep = Dep.of(context);
  }

  PgdeLocalization();

  PgdeLocalization._(BuildContext context)
      : _$dep = Localizations.of<Dep>(context, Dep);

  Dep _$dep;

  String get depValue => _$dep.depValue;
