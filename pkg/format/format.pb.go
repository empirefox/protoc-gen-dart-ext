...
func (TimeFormat_Builtin) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_format_23c839b9338e5b7d, []int{1, 0}
}
...
func (TimeFormat_IntUnit) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_format_23c839b9338e5b7d, []int{1, 1}
}
...
func (NumberFormat_Builtin) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_format_23c839b9338e5b7d, []int{3, 0}
}
...
func (*Format) Descriptor() ([]byte, []int) {
	return fileDescriptor_format_23c839b9338e5b7d, []int{0}
}
...
type TimeFormat struct {
	...
	IntUnit              TimeFormat_IntUnit `protobuf:"varint,4,opt,name=intUnit,proto3,enum=format.TimeFormat_IntUnit" json:"intUnit,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (*TimeFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_format_23c839b9338e5b7d, []int{1}
}
...
type TimeFormat_Builtin_ struct {
	Builtin TimeFormat_Builtin `protobuf:"varint,1,opt,name=builtin,proto3,enum=format.TimeFormat_Builtin,oneof"`
}
...
func (*CurrencyFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_format_23c839b9338e5b7d, []int{2}
}
...
type CurrencyFormat_Code struct {
	Code CurrencyV1 `protobuf:"varint,1,opt,name=code,proto3,enum=format.CurrencyV1,oneof"`
}
type CurrencyFormat_Symbol struct {
	Symbol CurrencyV1 `protobuf:"varint,2,opt,name=symbol,proto3,enum=format.CurrencyV1,oneof"`
}
type CurrencyFormat_Name struct {
	Name CurrencyV1 `protobuf:"varint,3,opt,name=name,proto3,enum=format.CurrencyV1,oneof"`
}
...
func (*NumberFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_format_23c839b9338e5b7d, []int{3}
}
...
type NumberFormat_Builtin_ struct {
	Builtin NumberFormat_Builtin `protobuf:"varint,1,opt,name=builtin,proto3,enum=format.NumberFormat_Builtin,oneof"`
}
...
func init() {
	proto.RegisterType((*Format)(nil), "format.Format")
	proto.RegisterType((*TimeFormat)(nil), "format.TimeFormat")
	proto.RegisterType((*CurrencyFormat)(nil), "format.CurrencyFormat")
	proto.RegisterType((*NumberFormat)(nil), "format.NumberFormat")
	proto.RegisterEnum("format.TimeFormat_Builtin", TimeFormat_Builtin_name, TimeFormat_Builtin_value)
	proto.RegisterEnum("format.TimeFormat_IntUnit", TimeFormat_IntUnit_name, TimeFormat_IntUnit_value)
	proto.RegisterEnum("format.NumberFormat_Builtin", NumberFormat_Builtin_name, NumberFormat_Builtin_value)
	proto.RegisterExtension(E_Format)
}

func init() { proto.RegisterFile("protos/format/format.proto", fileDescriptor_format_23c839b9338e5b7d) }

var fileDescriptor_format_23c839b9338e5b7d = []byte{
	// 647 bytes of a gzipped FileDescriptorProto
	,
}
