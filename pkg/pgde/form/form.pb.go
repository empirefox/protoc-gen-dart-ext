...
import (
	...
	zero "github.com/empirefox/protoc-gen-dart-ext/pkg/pgde/zero"
...
func (RadioInput_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_23d710dfe11887bd, []int{11, 0}
}
...
func (InputDecoration_CounterType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_23d710dfe11887bd, []int{15, 0}
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*Empty) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Empty_NoChange)(nil),
		(*Empty_Implicit)(nil),
		(*Empty_Explicit)(nil),
...
var fileDescriptor_23d710dfe11887bd = []byte{
	...
	,
}
