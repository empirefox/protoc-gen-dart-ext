...
type TimeFormat struct {
	...
	IntUnit              TimeFormat_IntUnit `protobuf:"varint,3,opt,name=intUnit,proto3,enum=pgde.format.TimeFormat_IntUnit" json:"intUnit,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
type NumberFormat struct {
	...
	Ordinal              bool                `protobuf:"varint,4,opt,name=ordinal,proto3" json:"ordinal,omitempty"`
	Unit                 *units.Unit         `protobuf:"bytes,5,opt,name=unit,proto3" json:"unit,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
var fileDescriptor_f2375ce5ebe45416 = []byte{
	...
	,
}
